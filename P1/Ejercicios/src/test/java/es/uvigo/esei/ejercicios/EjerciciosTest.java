...
public class EjerciciosTest {
    ...
    public void testFactorial() {
        ...
        int num = 4;
        long expResult = 24;
        assertEquals(expResult, Ejercicios.ejercicio1(num));
    }
    ...
    public void testSquare() {
        ...
        int num = 5;
        int expResult = 25;
        assertEquals(expResult, Ejercicios.ejercicio2(num));
    }
    ...
    public void testSumDigits() {
        ...
        int num = 1111;
        int expResult = 4;
        assertEquals(expResult, Ejercicios.ejercicio3(num));
    }
    ...
    public void testMcd() {
        ...
        int num2 = 12;
        int expResult = 2;
        assertEquals(expResult, Ejercicios.ejercicio4(num1, num2));
    }
    ...
    public void testInvert() {
        ...
        assertEquals(expResult, Ejercicios.ejercicio5(str));
    }
    ...
    public void testSumArray() {
        ...
        int[] input = {2, 4, 6, 8};
        int expResult = 20;
        assertEquals(expResult, Ejercicios.ejercicio6(input));
    }
    ...
    public void testInvertArray() {
        ...
        Ejercicios.ejercicio7(input, 0, input.length-1);
    ...
    public void testMinimum() {
        ...
        int[] input = {4, 3, 6, 2, 8};
        int expResult = 2;
        assertEquals(expResult, Ejercicios.ejercicio8(input));
    }
