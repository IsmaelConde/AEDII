...
import Arboles_TADs.*;
import es.uvigo.actividad2.Actividad2;
...
public class SolActividad2Test {   
    ...
    public void testVacioCopia() {
        ...
        ArbolBinario result = Actividad2.copiarArbolSinHojas(vacio);
    ...
    public void testCopia() {
        ...
        ArbolBinario result = Actividad2.copiarArbolSinHojas(raiz);
        boolean eq = Actividad2.identicos(expResult, result);
        assertTrue(eq);
    }
    */
    ...
    public void testVacioEliminarHojas() {
        ...
        ArbolBinario expResult = vacio;
        ArbolBinario result = Actividad2.copiarArbolSinHojas(hoja1);
        boolean eq = Actividad2.identicos(expResult, result);
        assertTrue(eq);
    }
    @Test
    ...
    public void testAlturaVacio() {
        ...
        int expResult = -1;
        int result = Actividad2.calcularAltura(vacio);
        assertEquals(expResult, result);
    }
    @Test
    public void testAlturaHoja() {
        ...
        int expResult = 0;
        int result = Actividad2.calcularAltura(hoja1);
        assertEquals(expResult, result);
    }
    @Test
    public void testAltura() {
        ...
        int expResult = 2;
        int result = Actividad2.calcularAltura(raiz);
        assertEquals(expResult, result);
    }
    ...
    public void testVacioEsArbolSeleccion() {
        ...
        boolean expResult = true;
        boolean result = Actividad2.esArbolSeleccion(vacio);
        assertEquals(expResult, result);
    ...
    public void testHojaEsArbolSeleccion() {
        ...
        boolean expResult = true;
        boolean result = Actividad2.esArbolSeleccion(hoja1);
        assertEquals(expResult, result);
    }
    @Test
    public void testNoEsArbolSeleccion() {
        ...
        boolean expResult = false;
        boolean result = Actividad2.esArbolSeleccion(raiz);
        assertEquals(expResult, result);   
    }
    @Test
    public void testEsArbolSeleccion() {
        ...
        boolean expResult = true;
        boolean result = Actividad2.esArbolSeleccion(selec);
        assertEquals(expResult, result);
    }
   ...
   /**
    ...
    public void testExisteSuma() {
        ...
        Integer suma = 11;
        boolean expResult = true;
        boolean result = Actividad2.existeSuma(arbol, suma);
        assertEquals(expResult, result);
    }
    @Test
    ...
    public void testCopiaHastaNivel2() {
        ...
        ArbolBinario expResult = raiz;
        ArbolBinario result = Actividad2.copiaHastaNivel(raiz, 2);
        boolean eq = Actividad2.identicos(expResult, result);
        assertTrue(eq);
    }
    @Test
